...
class ContaMovimentacaoTest {
    ...
    void adicionarCredito_DeveCreditarComSucesso() {
        ...
        contaDTO.setSaldo(100.0); // valor de crédito
        ...
        ModelConta result = contaMovimentacao.AdicionarCredito(contaDTO);

        assertEquals(150.0, result.getSaldo());
        verify(contaRepository).save(any(ModelConta.class)); // não testa igualdade de referência
    }
