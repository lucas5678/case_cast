...
@Component
public class TransferenciaStrategy implements MovimentacaoStrategy {
    
    private final ContaRepository contaRepository;
    
    public TransferenciaStrategy(ContaRepository contaRepository) {
    ...
    public ModelConta executar(ModelConta conta) {
        // Para transferência, esperamos que o conta contenha os dados da transferência
        // Este método precisa ser adaptado para receber ModeloTransferDTO
        throw new ContaException("Use o método executarTransferencia para operações de transferência");
    }
    
    @Transactional
    public ModeloTransferDTO executarTransferencia(ModeloTransferDTO transferencia) {
